...
public class CMMN11Parser extends XMLBasedLanguageParser<TDefinitions>
  ...
  public CMMN11Parser(Collection<XMLBasedLanguageParser<?>> subParsers) {
    super(subParsers);
    setId(SemanticIdentifier.newId(id, version));
    configRootClass(TDefinitions.class);
  ...
  public KnowledgeCarrier newVerticalCarrier(
    ...
    if (ParsingLevelSeries.Abstract_Knowledge_Expression.sameAs(targetLevel)) {
      ...
      if (kc.getArtifactId() == null) {
        ...
        kc.withArtifactId(
            newVersionId(URIUtil.normalizeURI(URI.create(ns)), IdentifierConstants.VERSION_LATEST));
      }
      if (kc.getLabel() == null) {
